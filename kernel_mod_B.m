function func=kernel_mod_B(a,b)
...
% argument b: scalar, previous/source
    ...
    tmp11=R21transport(b,a);
    tmp12=R22transport(b,a);
    ...
    tmp13=interp1(s_ele,R11_ele,b)*emitx*(func_W*alphax0-func_V*betax0);
    tmp14=interp1(s_ele,R12_ele,b)*emitx*(func_W*gammax0-func_V*alphax0);
    tmp15=interp1(s_ele,R16_ele,b)*sigma_delta^2*func_U;
    tmp16=interp1(s_ele,R21_ele,b)*emitx*(func_W*alphax0-func_V*betax0);
    tmp17=interp1(s_ele,R22_ele,b)*emitx*(func_W*gammax0-func_V*alphax0);
    tmp18=interp1(s_ele,R26_ele,b)*sigma_delta^2*func_U;
    tmp19=R26transport(b,a);
