function func=convert_mod(a,b)

% input of this subroutine: a is a vector, b is a scalar 
% output of this subroutine: a vector func

    global egamma egamma_vec k_wave s_ele C_ele sig_x_ele sig_y_ele betax0 betay0 sigma_delta re nb full_pipe_height emit_norm_x emit_norm_y emitx emity;
    global iCSR_ss iCSR_tr iCSR_drift iLSC ilinac;
