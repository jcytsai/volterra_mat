function func=R33transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R33_ele,a).*interp1(s_ele,R44_ele,b); % vector
    tmp02=interp1(s_ele,R43_ele,b).*interp1(s_ele,R34_ele,a); % vector
