function func=R12transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R12_ele,a).*interp1(s_ele,R11_ele,b); % vector
    tmp02=interp1(s_ele,R12_ele,b).*interp1(s_ele,R11_ele,a); % vector
