function func=R21transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R21_ele,a).*interp1(s_ele,R22_ele,b); % vector
    tmp02=interp1(s_ele,R21_ele,b).*interp1(s_ele,R22_ele,a); % vector
