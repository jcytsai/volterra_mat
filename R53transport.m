function func=R53transport(b,a)
...
%
    global s_ele R53_ele R54_ele R43_ele R44_ele;
    
    tmp01=interp1(s_ele,R44_ele,b);                           % scalar
    tmp02=interp1(s_ele,R43_ele,b);                           % scalar
    tmp03=interp1(s_ele,R53_ele,a)-interp1(s_ele,R53_ele,b);  % vector
    tmp04=interp1(s_ele,R54_ele,a)-interp1(s_ele,R54_ele,b);  % vector
