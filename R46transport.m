function func=R46transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R44_ele,a).*interp1(s_ele,R53_ele,b); % vector
    tmp02=interp1(s_ele,R54_ele,b).*interp1(s_ele,R43_ele,a); % vector
    tmp03=interp1(s_ele,R46_ele,a);                           % vector
