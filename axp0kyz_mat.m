function func=axp0kyz_mat(s)
    ...
    func05=gammay0*(betay0-(k_wave*tmp01).^2*emity.*tmp38.^2);           
    func06=alphay0*(alphay0-(k_wave*tmp01).^2*emity.*tmp38.*tmp39);    
    func07=gammay0*(alphay0-(k_wave*tmp01).^2*emity.*tmp38.*tmp39);           
    func08=alphay0*(gammay0-(k_wave*tmp01).^2*emity.*tmp39.^2);    
    func01=gammay0*(-(k_wave*tmp01).^2*emitx.*tmp36.*tmp38);           
    func03=gammay0*(-(k_wave*tmp01).^2*emitx.*tmp37.*tmp38);    
    func02=alphay0*(-(k_wave*tmp01).^2*emitx.*tmp36.*tmp39);           
    func04=alphay0*(-(k_wave*tmp01).^2*emitx.*tmp37.*tmp39);
    func09=gammay0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp38);  
    func10=alphay0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp39);
    
    func_tmp=tmp20.*(func01+func02)+tmp21.*(func03+func04)+tmp22.*(func05+func06)+tmp23.*(func07+func08)+tmp33.*(func09+func10);
    func=func_tmp*ay_1k0.*LD;
