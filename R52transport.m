function func=R52transport(b,a)
...
%
    global s_ele R51_ele R52_ele R11_ele R12_ele;
    
    tmp01=interp1(s_ele,R11_ele,b);                           % scalar
    tmp02=interp1(s_ele,R12_ele,b);                           % scalar
    tmp03=interp1(s_ele,R52_ele,a)-interp1(s_ele,R52_ele,b);  % vector
    tmp04=interp1(s_ele,R51_ele,a)-interp1(s_ele,R51_ele,b);  % vector
