function func=ayp0kypz_mat(s)
    ...
    func05=alphay0*(betay0-(k_wave*tmp01).^2*emity.*tmp38.^2);           
    func06=betay0*(alphay0-(k_wave*tmp01).^2*emity.*tmp38.*tmp39);    
    func07=alphay0*(alphay0-(k_wave*tmp01).^2*emity.*tmp38.*tmp39);           
    func08=betay0*(gammay0-(k_wave*tmp01).^2*emity.*tmp39.^2);    
    func01=alphay0*(-(k_wave*tmp01).^2*emitx.*tmp36.*tmp38);           
    func03=alphay0*(-(k_wave*tmp01).^2*emitx.*tmp37.*tmp38);    
    func02=betay0*(-(k_wave*tmp01).^2*emitx.*tmp36.*tmp39);           
    func04=betay0*(-(k_wave*tmp01).^2*emitx.*tmp37.*tmp39);
    func09=alphay0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp38);  
    func10=betay0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp39);
    
    func_tmp=tmp28.*(func01+func02)+tmp29.*(func03+func04)+tmp30.*(func05+func06)+tmp31.*(func07+func08)+tmp35.*(func09+func10);
    func=func_tmp*ayp_1k0.*LD;
