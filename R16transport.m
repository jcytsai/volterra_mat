function func=R16transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R12_ele,a).*interp1(s_ele,R51_ele,b); % vector
    tmp02=interp1(s_ele,R52_ele,b).*interp1(s_ele,R11_ele,a); % vector
    tmp03=interp1(s_ele,R16_ele,a);                           % vector
