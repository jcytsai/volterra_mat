...
% Last Modified by GUIDE v2.5 11-Oct-2022 12:40:26
...
global iIBS DO_X DO_Y DO_Z iDz iDzz itransLD use_orig_mat_output plot_Zk_vs_s iSES CSRdrifmodel Derbenev checkbox33 checkbox34 checkbox35 iFEL_calc gen_CSR_LSC_param
...
checkbox33=handles.checkbox33.Value;  % for FEL_calc
checkbox34=handles.checkbox34.Value;  % generate CSRCSBEND, CSRDRIFT, LSCDRIFT
checkbox35=handles.checkbox35.Value;  % save as SDDS
...
iFEL_calc=handles.iFEL_calc.Value;
...
function iFEL_calc_Callback(hObject, eventdata, handles)
% hObject    handle to iFEL_calc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of iFEL_calc as text
%        str2double(get(hObject,'String')) returns contents of iFEL_calc as a double


% --- Executes during object creation, after setting all properties.
function iFEL_calc_CreateFcn(hObject, eventdata, handles)
% hObject    handle to iFEL_calc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
