function func=ayp0kxpz_mat(s)
    ...
    func01=alphax0*(betax0-(k_wave*tmp01).^2*emitx.*tmp36.^2);           
    func02=betax0*(alphax0-(k_wave*tmp01).^2*emitx.*tmp36.*tmp37);    
    func03=alphax0*(alphax0-(k_wave*tmp01).^2*emitx.*tmp36.*tmp37);           
    func04=betax0*(gammax0-(k_wave*tmp01).^2*emitx.*tmp37.^2);    
    func05=alphax0*(-(k_wave*tmp01).^2*emity.*tmp36.*tmp38);           
    func06=betax0*(-(k_wave*tmp01).^2*emity.*tmp37.*tmp38);    
    func07=alphax0*(-(k_wave*tmp01).^2*emity.*tmp36.*tmp39);           
    func08=betax0*(-(k_wave*tmp01).^2*emity.*tmp37.*tmp39);
    func09=alphax0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp36);  
    func10=betax0*((k_wave*tmp01).^2.*tmp06*sigma_delta^2.*tmp37);
    
    func_tmp=tmp28.*(func01+func02)+tmp29.*(func03+func04)+tmp30.*(func05+func06)+tmp31.*(func07+func08)+tmp35.*(func09+func10);
    func=func_tmp*axp_1k0.*LD;
