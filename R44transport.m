function func=R44transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R44_ele,a).*interp1(s_ele,R33_ele,b); % vector
    tmp02=interp1(s_ele,R34_ele,b).*interp1(s_ele,R43_ele,a); % vector
