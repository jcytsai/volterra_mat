...
% from the program.                                                       %
%                                                                         %
% Program written by Cheng-Ying Tsai, jcytsai@hust.edu.cn                 %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
global DO_X DO_Y DO_Z iDz iDzz itransLD use_orig_mat_output plot_Zk_vs_s iSES CSRdrifmodel Derbenev iFEL_calc gen_CSR_LSC_param checkbox33 checkbox34 checkbox35;
...
HH = findobj(gcf,'Tag','iFEL_calc');       iFEL_calc = HH.Value;
...
HH = findobj(gcf,'Tag','checkbox33');      checkbox33 = HH.Value;
HH = findobj(gcf,'Tag','checkbox34');      checkbox34 = HH.Value;
HH = findobj(gcf,'Tag','checkbox35');      checkbox35 = HH.Value;
%-------------------------------------------------------------------------%

save_SDDS=checkbox35;
iSES_ana=iSES;
...
%
% calculate final slice energy spread (SES), need to integrate over gain spectrum
if (checkbox33==1)
    iSES=1; 
    if (iEnergy_gain_calc==0)
        fprintf('FEL_calc requires iEnergy_gain_calc=1...\n'); pause;
    end
end
