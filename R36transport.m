function func=R36transport(b,a)
%
...
%
    ...
    tmp01=interp1(s_ele,R34_ele,a).*interp1(s_ele,R53_ele,b); % vector
    tmp02=interp1(s_ele,R54_ele,b).*interp1(s_ele,R33_ele,a); % vector
    tmp03=interp1(s_ele,R36_ele,a);                           % vector
