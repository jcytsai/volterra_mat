...
% output of this subroutine: a vector func
    ...
    global iIBS s_IBS tau_inv_IBS D_IBS_z sigma_delta_IBS;
    ...
    emitx_vec_tmp=emitx*egamma_vec(1)./egamma_vec; emitx_vec=interp1(s_ele,emitx_vec_tmp,s_IBS,'linear','extrap');
    emity_vec_tmp=emity*egamma_vec(1)./egamma_vec; emity_vec=interp1(s_ele,emity_vec_tmp,s_IBS,'linear','extrap');
    ...
    tmp06=0.5*k_wave^2*emitx_vec(ind)/(betax0);
    ...
    tmp09=0.5*k_wave^2*emity_vec(ind)/(betay0);
