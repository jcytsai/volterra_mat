function [s_m alphax_m alphay_m betax_m betay_m psix_m psiy_m]=dipole_info_Twiss(flag)
...
%figure(1); plot(1.5:1:(cc-0.5),diff(psix_m/pi),'blacko--'); xlabel('index'); ylabel('N-N beta phase difference ({\pi})'); hold on;
%figure(2); plot(1:1:cc,alphax_m,'ro--'); xlabel('dipole index'); ylabel('\alpha function'); hold on;
%figure(3); plot(1:1:cc,betax_m,'bo--');  xlabel('dipole index'); ylabel('\beta function (m)'); hold on;
